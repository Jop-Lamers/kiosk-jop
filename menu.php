...
<body class="menu-mode">
    ...
    <script>
        ...
        window.allCategories = {
            <?php foreach ($categories as $cat): ?> "<?php echo $cat['category_id']; ?>": "<?php echo addslashes($cat['name']); ?>",
            <?php endforeach; ?>
        };
        ...
        window.productImages = {
            <?php foreach ($products as $p): ?> "<?php echo $p['product_id']; ?>": "<?php echo pick_image_for_product($p, $allImages) ? ('menu-images/' . rawurlencode(pick_image_for_product($p, $allImages))) : 'logos/logo-images/logo happy herbivore.webp'; ?>",
            <?php endforeach; ?>
        };
    </script>
