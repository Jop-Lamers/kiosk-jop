...
<body class="menu-mode">
    ...
    <button class="hamburger-btn" id="hamburger-menu" aria-label="Toggle menu">
        <span></span>
        <span></span>
        <span></span>
    </button>
    ...
    <div class="kiosk-container">
        ...
        <aside class="sidebar">
            <div class="logo-small">
                <div class="logo-circle">
                    <img src="logos/logo-images/logo happy herbivore.webp" alt="Logo" class="main-logo">
                </div>
            </div>
            ...
            <div class="sidebar-footer">
                <div class="lang-toggle">
                    <button class="lang-btn active" id="lang-menu-nl" onclick="setLang('NL')" aria-label="Nederlands">
                        <span class="lang-flag" aria-hidden="true">🇳🇱</span>
                    </button>
                    <button class="lang-btn" id="lang-menu-en" onclick="setLang('EN')" aria-label="English">
                        <span class="lang-flag" aria-hidden="true">🇬🇧</span>
                    </button>
                </div>
            </div>
        ...
        <aside class="order-panel">
            ...
            <div class="cart-footer">
                ...
                <button id="checkout-btn" class="checkout-btn" disabled onclick="showCheckoutUpsell()">Nu Betalen</button>
            </div>
        </aside>
    </div>
    ...
    <div id="custom-modal" class="modal-overlay hidden">
        <div class="modal-content">
            ...
            <!-- Checkout Upsell Screen -->
            <div id="upsell-view" class="modal-body hidden">
                <div class="upsell-screen-content">
                    <h2 id="upsell-view-title">Lekker voor erbij?</h2>
                    <p class="upsell-sub" id="upsell-sub-title">Voeg nog iets toe aan je bestelling</p>
                    <div id="upsell-suggestions-grid" class="upsell-suggestions-grid">
                        <!-- Dynamically filled -->
                    </div>
                </div>
                <div class="upsell-actions">
                    <button id="upsell-skip-btn" class="skip-btn" onclick="skipUpsell()">Nee bedankt, ga nu afrekenen &rarr;</button>
                </div>
            </div>
        </div>
    </div>
